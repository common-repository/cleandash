...
function wph_cleandash__remove_footer_admin() {
	echo '<span id="footer-thankyou">Built with <a href="https://wordpress.org/" target="_blank">WordPress</a>. Dashboard styled with love by <a href="https://www.wpharvest.com/cleandash/" target="_blank">CleanDash</a>. </span>';
}
add_filter( 'admin_footer_text', 'wph_cleandash__remove_footer_admin' );

// Enqueue stylesheet
function wph_cleandash_enqueue_stylesheet() {
	wp_enqueue_style( 'cleandash', plugins_url( '/assets/cleandash.css', __FILE__ ), array(), '1.0.1' );
}
